...
export const UploadIcon: React.FC = () => (
  ...
  >
    <path
      ...
      strokeWidth="2"
      d="M7 16a4 4 0 01-4-4V7a4 4 0 014-4h5l4 4v1.5M12 10v10m0 0l-3-3m3 3l3-3"
    ></path>
  </svg>
);
...
export const FileCodeIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500">
        <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><path d="m10 13-2 2 2 2"></path><path d="m14 17 2-2-2-2"></path>
    </svg>
);
...
export const WandIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-indigo-400">
        <path d="M15 4V2"></path><path d="M15 16v-2"></path><path d="M8 9h2"></path><path d="M20 9h2"></path><path d="M17.8 11.8 19 13"></path><path d="m3 21 9-9"></path><path d="M12.2 6.2 11 5"></path><path d="m5 12-2 2 9-9"></path><path d="M19 21h2"></path><path d="M4 3h2"></path><path d="M21 15h-2"></path><path d="M3 4v2"></path><path d="M21 20v-2"></path>
    </svg>
);
